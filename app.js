...
if (trigrams) {
    html += `
      <div class="trigrams-info">
        <p><strong>Trigramma superiore (esterno):</strong> ${trigrams.upper.name} <span class="ideogram">${trigrams.upper.ideogram}</span> — ${trigrams.upper.translation}</p>
        <p style="margin-left: 1rem;"><em>Immagine:</em> ${trigrams.upper.image}<br><em>Significato:</em> ${trigrams.upper.meaning}</p>
        
        <p><strong>Trigramma inferiore (interno):</strong> ${trigrams.lower.name} <span class="ideogram">${trigrams.lower.ideogram}</span> — ${trigrams.lower.translation}</p>
